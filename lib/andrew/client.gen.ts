// Code generated by the Encore v1.10.4 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-andrew-naz2.encr.app`
}

/**
 * Client is an API client for the andrew-naz2 Encore application. 
 */
...
export namespace content {
    ...
    export class ServiceClient {
         ...
         */
        public async CreatePost(params: CreatePostParams): Promise<CreatePostResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/content/posts`, JSON.stringify(params))
         ...
         */
        public async GetPost(slug: string): Promise<GetPostResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/content/posts/${encodeURIComponent(slug)}`)
            return await resp.json() as GetPostResponse
        }
        ...
        public async GetPosts(): Promise<GetPostsResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/content/posts`)
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        this.headers = {
            ...
            "User-Agent":   "andrew-naz2-Generated-TS-Client (Encore/v1.10.4)",
        }
